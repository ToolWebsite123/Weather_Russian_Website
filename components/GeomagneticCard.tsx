...
export function GeomagneticCard({ data }: { data: GeomagneticData | null }) {
  ...
  return (
    <div id="geomagnetic" className="scroll-mt-24 rounded-2xl bg-white/95 p-4 ring-1 ring-sky-100/80 shadow-xs backdrop-blur sm:p-5 text-slate-900">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-h3 font-semibold text-sky-950">
            ...
            <div key={level} className="flex flex-col items-center gap-1">
              <div
                className={`h-3 w-full rounded-full transition-all ${
                  isCurrent ? `${colorClass} ring-2 ring-sky-600 scale-105 shadow-xs` : `${colorClass} opacity-35`
                }`}
              />

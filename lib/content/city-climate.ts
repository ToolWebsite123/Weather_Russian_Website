...
export const CITY_CLIMATE_MAP: Record<string, CityClimateProfile> = {
  "saint-petersburg": {
    ...
    faqs: [
      ...
      {
        question: "Какое нормальное атмосферное давление в Санкт-Петербурге?",
        answer:
          "Для Санкт-Петербурга нормальным считается атмосферное давление 758–762 мм рт. ст., так как город находится непосредственно на уровне моря.",
      },
      {
  ...
  moscow: {
    ...
    faqs: [
      {
        question: "Какое нормальное атмосферное давление в Москве?",
        answer:
          "Из-за средней высоты столицы (130–150 метров над уровнем моря) нормальное атмосферное давление в Москве составляет 747–749 мм рт. ст.",
      },
    ],
  },
};

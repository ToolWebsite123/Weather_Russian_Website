...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Геомагнитная активность ${locative} — магнитные бури | WeatherHub`;
  const description = `Прогноз геомагнитной активности (Kp-индекс) и магнитных бурь ${locative}. Мониторинг возмущений магнитного поля Земли.`;
  ...
  return {
    ...
    alternates: { canonical: `${config.siteUrl}/pogoda/${city.slug}/gm-aktivnost` },
    openGraph: {
      title,
      description,
      url,
...
export default function GmAliasPage({ params }: Props) {

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Погода ${locative} вчера — архив метеонаблюдений | WeatherHub`;
  const description = `Какая погода была ${locative} вчера: фактическая температура, минимальные и максимальные значения.`;

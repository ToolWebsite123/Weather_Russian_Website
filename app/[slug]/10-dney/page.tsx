...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Точный прогноз погоды ${locative} на 10 дней: температура воздуха, осадки, ветер и давление.`;
...
export default function TenDneyWeatherPage({ params }: Props) {
  return (
    <CityWeatherView
      slug={params.slug}
      active="10-dney"

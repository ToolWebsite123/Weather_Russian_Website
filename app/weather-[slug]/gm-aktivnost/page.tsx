...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Прогноз магнитных бурь и Kp-индекса геомагнитных возмущений ${locative}. Информация для метеозависимых.`;
...
export default function GmAktivnostWeatherPage({ params }: Props) {

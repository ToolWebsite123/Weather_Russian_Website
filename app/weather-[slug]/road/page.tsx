...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Состояние дорог ${locative} — риск гололёда | WeatherHub`;
  const description = `Оценка безопасности дорожного движения ${locative}: риск гололедицы, снежный накат и видимость.`;
...
export default function RoadWeatherPage({ params }: Props) {

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Погода ${locative} завтра — точный прогноз по часам | WeatherHub`;
  const description = `Точный прогноз погоды ${locative} на завтра: почасовая температура, вероятность осадков и ветер.`;

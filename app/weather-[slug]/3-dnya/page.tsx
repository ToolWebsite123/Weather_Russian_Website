...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Погода ${locative} на 3 дня — подробный прогноз | WeatherHub`;
  const description = `Подробный почасовой и суточный прогноз погоды ${locative} на ближайшие 3 дня.`;

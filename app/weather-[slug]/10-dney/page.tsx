...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Погода ${locative} на 10 дней — точный прогноз | WeatherHub`;
  const description = `Прогноз погоды ${locative} на 10 дней: динамика температуры, осадки, давление и тренды.`;

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Архив погоды ${locative} — исторические данные по годам | WeatherHub`;
  const description = `Архив погоды ${locative}: смотрите температуру, осадки и архив метеонаблюдений за прошлые годы.`;
...
export default function ArchivWeatherPage({ params }: Props) {
